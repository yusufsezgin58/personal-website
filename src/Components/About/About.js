  ...
  return (
    <div className={styles.about}>
      ...
      <div className={styles.text}>
        <h4>About Me</h4>
        <p>Hello my name is Yusuf. Thank you very much for visit my website. I living in Istanbul. I
          developing myself in web development approximately 1 year. You can access many informations in
          this website.
        </p>

        <div className={styles.social}>
          <a href='https://www.instagram.com/ssezgin16/' target={"_blank"}>
          ...
          <a href='https://twitter.com/werti11goq11' target={"_blank"}>
